  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "BigIELTS.com — Recent IELTS Questions & Sample Answers" },
      {
        ...
        content:
          "Practice with the most recent IELTS Writing and Speaking questions. Band 8–9 model answers, vocab, and exam strategies.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&family=Caveat:wght@500;600;700&family=Playfair+Display:ital,wght@0,700;0,800;1,700;1,800&family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500&family=Space+Grotesk:wght@500;600;700&family=DM+Sans:wght@400;500;600;700&family=Poppins:wght@500;600;700;800&display=swap",
      },
    ],
  }),
